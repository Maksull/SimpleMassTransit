...
namespace SimpleMassTransitApi.Tests.IntegrationTests.Endpoints
{
    public sealed class ProductsEndpointsTests
    {
            ...
            _factory = new WebApplicationFactory<Program>()
                .WithWebHostBuilder(b =>
                {
                    b.ConfigureServices((services) =>
                    {
                        ...
                        {
                            options.UseInMemoryDatabase("InMemoryProductsEndpoint");
                        });
                    });
                });
        ...
        public async Task GetProducts_WithExistingProducts_ReturnsOkResultWithProducts()
        {
            ...
            // Act
            var response = await _client.GetAsync("/api/mini/products");
        ...
        public async Task GetProduct_WhenExist_ReturnOkProduct()
        {
            ...
            //Act
            var response = await _client.GetAsync($"/api/mini/products/{product.ProductId}");
            response.EnsureSuccessStatusCode();
            var responseContent = await response.Content.ReadAsStringAsync();
        ...
        public async Task GetProduct_WhenNotExist_ReturnNotFound()
        {
            ...
            //Act
            var response = await _client.GetAsync($"/api/mini/products/{Guid.Empty}");
        ...
        public async Task CreateProduct_ReturnOk()
        {
            ...
            // Act
            var postResponse = await _client.PostAsync("/api/mini/products", content);

            var getResponse = await _client.GetAsync("/api/mini/products");
        ...
        public async Task UpdateProduct_WhenExist_ReturnOk()
        {
            ...
            //Act
            var putResponse = await _client.PutAsync("/api/mini/products", content);
        ...
        public async Task DeleteProduct_WhenExist_ReturnOk()
        {
            ...
            //Act
            var putResponse = await _client.DeleteAsync($"/api/mini/products/{product.ProductId}");
        ...
        public async Task DeleteProduct_WhenNotExist_ReturnNotFound()
        {
            ...
            //Act
            var putResponse = await _client.DeleteAsync($"/api/mini/products/{Guid.NewGuid()}");
